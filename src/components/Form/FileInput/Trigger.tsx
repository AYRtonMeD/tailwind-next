...
export function Trigger() {
  ...
  return (
    <label
      htmlFor={id}
      className={`group flex-1 cursor-pointer flex flex-col items-center gap-3 rounded-lg border 
                border-zinc-300 px-6 py-4 text-center text-zinc-500 shadow-sm hover:border-violet-200 
