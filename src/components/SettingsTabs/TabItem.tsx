  ...
  return (
    <Tabs.Trigger
      ...
      className={`relative px-1 pb-4 text-sm font-medium text-zinc-500 hover:text-violet-700 
        hover:cursor-pointer data-[state=active]:text-violet-700 outline-none group dark:text-zinc-400 dark:data-[state=active]:text-violet-300 dark:hover:text-violet-300`}
    >
